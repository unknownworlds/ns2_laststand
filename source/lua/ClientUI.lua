...
kShowAsClass["Marine"] = { ["Hud/Marine/GUIMarineHUD"] = true, GUIPoisonedFeedback = true, GUIPickups = true, GUIOrders = true,
                           GUISensorBlips = true,  GUIProgressBar = true, GUIRequestMenu = true,
                           GUIWaypoints = true }
kShowAsClass["JetpackMarine"] = { GUIJetpackFuel = true, GUIJetpackRealFuel = true }
...
kShowAsClass["Alien"] = { GUIProgressBar = true, GUIRequestMenu = true, GUIWaypoints = true, GUIAlienHUD = true,
...
kShowAsClass["LSReadyRoomPlayer"] = { }
