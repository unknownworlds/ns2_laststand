...
function InfestationAbility:GetPositionForInfestation(player)
    ...
    if trace.fraction == 1 then
        ...
        trace = Shared.TraceRay(origin, origin - Vector(0, InfestationAbility.kInfestationRange, 0), CollisionRep.Default, PhysicsMask.AllButPCsAndRagdolls, EntityFilterTwo(player, self))
